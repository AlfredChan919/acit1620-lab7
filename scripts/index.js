...
function setup() {
    ...
    let previousvalue = getNumberInput().value;
    getNumberInput().addEventListener('input', (e) => {
        ...
        // if (e.target.value == getNumberInput().value)
...
function activate() {
    ...
    // getCheckbox().toggleAttribute('checked');
...
function play() {
    ...
    const randomizedTiles = shuffle(Array.from(tiles)); //convert NodeList into an Array list
